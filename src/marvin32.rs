...
mod tests {
    ...
    fn test_marvin32() {
        ...
        assert_eq!(
            0x24EAA279D9A529CA,
            marvin32(seed_3, &[0x00, 0xFF, 0x00, 0xFF], 4)
        );
        assert_eq!(
            0xD3BEC7726B057943,
            marvin32(seed_3, &[0xFF, 0x00, 0xFF, 0x00], 4)
        );
        assert_eq!(
            0x920B62BBCA3E0B72,
            marvin32(seed_3, &[0xFF, 0x00, 0xFF, 0x00, 0xFF], 5)
        );
        assert_eq!(
            0x1D7DDF9DFDF3C1BF,
            marvin32(seed_3, &[0x00, 0xFF, 0x00, 0xFF, 0x00], 5)
        );
        assert_eq!(
            0xEC21276A17E821A5,
            marvin32(seed_3, &[0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF], 6)
        );
        assert_eq!(
            0x6911A53CA8C12254,
            marvin32(seed_3, &[0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00], 6)
        );
        assert_eq!(
            0xFDFD187B1D3CE784,
            marvin32(seed_3, &[0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF], 7)
        );
        assert_eq!(
            0x71876F2EFB1B0EE8,
            marvin32(seed_3, &[0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00], 7)
        );
    }
}
